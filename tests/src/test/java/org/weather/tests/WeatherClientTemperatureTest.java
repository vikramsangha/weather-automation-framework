...
class WeatherClientTemperatureTest extends BaseWireMockTest{

    @DisplayName("Temperature Check")
    @Tag("temperature_check")
    @ParameterizedTest(name = "{0}")
    @MethodSource("temperatureTestData")
    void shouldValidateTemperatureForCity(String city, double latitude, double longitude){
    ...
    static Stream<Arguments> temperatureTestData() {
        return Stream.of(
